...
**This chart is a modified version of the one available in the ufficial helm stable repo. It contains an important fix that avoid hdfs to be formatted each time the namenode starts. It also allows to disable yarn.**
...
| `yarn.enabled`         |                          | Allows to enable/disable YARN                                                      | `true`
